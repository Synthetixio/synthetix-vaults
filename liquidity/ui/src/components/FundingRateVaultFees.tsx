  ...
  return (
    ...
    >
      ...
      <Flex direction="column" bg="whiteAlpha.50" borderRadius="md">
        ...
        <FeeRow
          title="Keeper Fee"
          description="A fixed fee to cover settlement costs on Perps v3"
          value={`$${wei(vaultData.keeperFee, 6).toString(2)}`}
        />
        <FeeRow
          title="Performance Fee"
          description="5% of profits generated by the vault's trading activities"
          value={`${formatPercentage(vaultData.performanceFee)}`}
        />
        <FeeRow
          title="Deposit Fee"
