		...
		<>
			...
			<Text color="gray.500" fontFamily="heading" fontSize="sm">
				...
				<Text color={totalRewards.gt(0) ? "green.500" : "gray.500"} as="span">
					{totalRewards.gt(0)
						? formatNumberToUsd(totalRewards.toNumber())
						: "-"}
				</Text>
			</Text>
		</>
...
export function PoolUnlockedCollateralValue({
	...
	const unlockedCollateralValue = position?.availableCollateral.mul(
	...
	return (
		<>
			<Text
				...
				color="white"
			>
				{unlockedCollateralValue
					? formatNumberToUsd(unlockedCollateralValue.toNumber())
					: "-"}
			</Text>
...
export function PoolActionButton({
	collateral,
	position,
	network,
