...
export function PoolsListMobile({ pools }: { pools: PoolWithPosition[] }) {
	return (
		<Flex direction="column" gap={4} mt={4} p={4} rounded="md" bg="navy.700">
			{pools.map(
				({ network, position, collateral, rewardsValue, totalValue }) => {
					const collateralValue = position?.collateralValue.mul(
							...
							<Flex justifyContent="space-between">
								<Flex alignItems="center" width="140px" color="gray.600">
									...
									<Tooltip
										label={
											<Text textAlign="left">
												APR is averaged over the trailing 28 days and is
												comprised of both performance and rewards
											</Text>
										}
									>
									...
									<Flex justifyContent="space-between">
										<Flex alignItems="center" width="140px" color="gray.600">
											...
											<Tooltip
												label={
													<Text textAlign="left">
														Deposits can be withdrawn 24h after unlocking or any
										...
										>
											{collateralValue
												? formatNumberToUsd(collateralValue.toNumber())
												: "-"}
										</Text>
									</Flex>
									...
									<Flex justifyContent="space-between">
										<Flex alignItems="center" width="140px" color="gray.600">
											...
											<Tooltip
												label={
													<Text textAlign="left">
														Unlocked assets can be locked into a position at any
														time or withdrawn after 24h since last activity
													</Text>
												}
											>
												<InfoIcon w="10px" h="10px" />
