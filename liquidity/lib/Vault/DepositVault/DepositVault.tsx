...
export const DepositVault = () => {
	...
	const { data: usdcBalance, refetch: refetchUSDCBalance } = useTokenBalance(
		USDCToken?.address,
	);
	...
	const { refetch: refetchPosition } = useStrategyPoolPosition(
	...
	return (
		<>
			<BorderBox mt={6} w="100%" display="flex" p={3} mb="6" bg="whiteAlpha.50" borderColor="whiteAlpha.200">
