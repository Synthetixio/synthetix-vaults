...
export function NewPoolMigrationV2x() {
            ...
            {v2xPosition && snxPrice ? (
              <Flex gap={6}>
                <Flex direction="column" gap={3}>
                  <Text>Deposited</Text>
                  <Amount value={wei(v2xPosition.collateralAmount)} suffix=" SNX" />
                  <Amount prefix="$" value={wei(v2xPosition.collateralAmount).mul(snxPrice)} />
                </Flex>
                <Flex direction="column" gap={3}>
                  <Text>Loan</Text>
                  <Amount prefix="$" value={wei(v2xPosition.debt)} />
                </Flex>
                <Flex direction="column" gap={3}>
                  <Text>C-Ratio</Text>
                  <CRatioAmount value={wei(v2xPosition.cRatio).toNumber() * 100} />
                </Flex>
              </Flex>
            ) : null}
