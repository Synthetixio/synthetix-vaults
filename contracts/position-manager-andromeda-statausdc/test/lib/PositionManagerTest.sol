...
contract PositionManagerTest is Test {
    ...
    constructor() {
        ...
        $synthStataUSDC = vm.parseJsonAddress(metaJson, ".contracts.CollateralToken_sStataUSDC");
        vm.label($synthStataUSDC, "$synthStataUSDC");
    ...
    function setUp() public {
        ...
        $stataUSDCPrecision = 10 ** IERC20($stataUSDC).decimals();
