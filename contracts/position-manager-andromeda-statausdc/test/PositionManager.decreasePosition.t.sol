...
contract PositionManager_decreasePosition_Test is PositionManagerTest {
    ...
    function test_decreasePosition() public {
        ...
        uint256 expectedStataTokenAmount = IStaticAaveToken($stataUSDC).previewWithdraw(
            //
            10 * $USDCPrecision
        );
        ...
        assertEq(currentPosition - expectedStataSynthAmount, newPosition);
        assertEq(expectedStataSynthAmount, newAvailable); // undelegated 10$ worth of stataUSDC which can be withdrawn after a timeout
    }
}
